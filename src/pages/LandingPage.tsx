...
const features: Feature[] = [
  ...
  },
  {
    ...
    desc: 'Registra y visualiza el ahorro mensual de cada miembro del fondo con total transparencia.',
  },
  {
    Icon: Wallet,
  ...
  },
  {
    ...
    desc: 'Genera reportes claros sobre el estado del fondo y sus movimientos en segundos.',
  },
]
    ...
    <section ref={ref} id="pricing" className="py-24 bg-white px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-slate-500 text-lg mb-8">Elige el plan que mejor se adapte a tu comunidad.</p>
